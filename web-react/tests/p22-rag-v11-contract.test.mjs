...
test('P22 single POST route decides on the accepted request (no double-submit preflight)', () => {
...
test('P22 default is AUTO and durable result is observed by existing pending-poll fallback', () => {
