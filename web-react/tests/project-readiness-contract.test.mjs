...
test('Knowledge Runtime V4.1 waits for the real project-create control after model service reload', () => {
...
test('Knowledge Runtime V4.1 retains the project dialog and light-theme assertions after readiness', () => {
  const flow = section('    // Conversation Reliability light-theme regression:', '    // Conversation Reliability Conversation Memory Reliability:');
