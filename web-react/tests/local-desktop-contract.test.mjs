...
test("Conversation Reliability Go local environment loads nearest .env.local without replacing real env", () => {
...
test("Conversation Reliability Desktop defaults to Local Computer Mode while preserving Restricted Mode", () => {
...
test("Conversation Reliability Desktop read tools describe normal local-computer access, while mutations remain approval-gated", () => {
