...
test("P9 exposes governance without exposing secret plaintext reads", () => {
...
test("P9 governance UI covers RBAC quota BYOK and audit", () => {
...
test("P9 browser API only writes secret and never requests decrypted value", () => {
...
test("P9 manual-preflight exposes organization operations and audit actor", () => {
