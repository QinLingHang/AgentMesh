#!/usr/bin/env python3
"""Collect all frozen Execution Routing decisions through the real internal HTTP endpoint."""
...
def main() -> int:
    ...
    parser.add_argument("--url", default="http://127.0.0.1:9572/internal/v1/routing/understand")
    ...
    for row in rows:
        ...
        body = json.dumps({
            "schemaVersion": "execution-routing.v1", "task": row["query"],
        ...
        results.append({
            ...
            "httpStatus": status, "source": "EXECUTION_ROUTING_REAL_INTERNAL_HTTP",
        })
