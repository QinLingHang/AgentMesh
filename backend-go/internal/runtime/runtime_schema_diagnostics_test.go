...
func TestKnowledgeRuntimeRuntimeValidationDiagnosticsAreRedacted(t *testing.T) {
...
func TestKnowledgeRuntimeRuntimeValidationDiagnosticsMalformedResponseIsSafe(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusUnprocessableEntity)
