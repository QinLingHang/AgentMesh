...
func registerGovernanceRoutes(protected *gin.RouterGroup, deps Dependencies) {
	...
	protected.GET("/me/model-services", deps.GovernanceHandler.ListUserModelServices)
	protected.POST("/me/model-services", deps.GovernanceHandler.CreateUserModelService)
