...
// p23ModelReadableAttachments is an optimization hint, never a permission.
...
func (s *TaskService) p23ModelReadableAttachments(ctx context.Context, uid int64, in RunTaskInput) bool {
