...
func TestKnowledgeRuntimeDirectIdentityIsStableAndRejectsPayloadReuse(t *testing.T) {
	input := RunTaskInput{
...
func TestKnowledgeRuntimeDirectReplayNeverClaimsPendingCompleted(t *testing.T) {
