...
// The P8 fixture uses an isolated disposable database; never use development DB.
func TestP22WorkerPhaseFenceDedupeAndOwnerReplay(t *testing.T) {
...
func TestP22WorkerPhaseRejectsUntrustedMetadata(t *testing.T) {
