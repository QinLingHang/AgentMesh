...
def test_p10_production_topology_has_single_public_gateway():
...
def test_p10_migration_and_secret_wiring_are_production_contracts():
    compose = (ROOT / "docker-compose.production.yml").read_text(encoding="utf-8")
...
def test_p10_gateway_supports_same_origin_api_and_optional_tls():
...
def test_p10_operations_scripts_and_backup_boundary_exist():
