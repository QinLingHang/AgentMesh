...
def test_offline_p7_cases_parse_and_exercise_policy_comparison():
    path = Path(__file__).resolve().parents[1] / "evals" / "p7_routing_cases.jsonl"
