"""Read-only binary execution routing.
...
class RoutingModelSelection(ModelSelection):
    model_config = ConfigDict(populate_by_name=True, extra="forbid")


class RoutingTaskConstraints(TaskConstraints):
    model_config = ConfigDict(populate_by_name=True, extra="forbid")
...
class ExecutionRoutingRequest(BaseModel):
    ...
    model_selection: RoutingModelSelection = Field(default_factory=RoutingModelSelection, alias="modelSelection", exclude=True)
    constraints: RoutingTaskConstraints = Field(default_factory=RoutingTaskConstraints, exclude=True)
...
def _attachment_comparison(req: ExecutionRoutingRequest, text: str) -> bool:
