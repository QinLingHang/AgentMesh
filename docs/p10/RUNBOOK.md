...
Restore overwrites the configured P10 data-volume namespace.
...
4. Because P1-P10 migrations are additive/idempotent, do not attempt ad-hoc
   reverse DDL.
