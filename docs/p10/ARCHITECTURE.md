# P10 Architecture — Production Operations + Real Deployment

P10 turns the P1-P9 application into an operable deployment without changing
...
MySQL, Redis, Milvus, MinIO and etcd are not published to the host in the P10
production topology.
...
Memory, Durable Runtime and P9 Governance schema.
...
The P10 backup workflow creates:
...
or `--force` (Linux) flag. It recreates only the configured P10 data-volume
...
## Security invariants retained from P9
