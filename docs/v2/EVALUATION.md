...
The P6 deterministic run scorecard remains the default runtime scorecard contract so existing persisted tasks and frontend contracts stay compatible.

V2 adds the following scorecard dimensions:
...
The synthetic V2 dataset can be executed without starting the whole Runtime:
