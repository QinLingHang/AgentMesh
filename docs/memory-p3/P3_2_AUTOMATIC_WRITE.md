# P3.2 Automatic Memory Write

P3.2 turns selected direct user statements into durable User-global memories.
...
Continuation/resume input is excluded from P3.2 automatic writes because it may contain OTP, auth material, approval responses, or other ephemeral task state.
