...
No embedding/vector retrieval exists in P3.1.
...
Requires the existing `X-Internal-Token` middleware and returns active memories. P3.1 does not yet connect this endpoint to Python prompt assembly.
