# AgentMesh V4 Ecosystem Security Boundaries
...
DNS rebinding、出站 egress proxy、云环境网络策略、Marketplace 签名/供应链证明、恶意包扫描属于 Final Production Closure / 后续生态强化，不在 V4 开发包中伪装为已完成。
